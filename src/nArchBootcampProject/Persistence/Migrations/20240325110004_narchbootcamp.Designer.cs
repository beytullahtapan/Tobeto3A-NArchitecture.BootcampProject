...
namespace Persistence.Migrations
{
    ...
    [Migration("20240325110004_narchbootcamp")]
    partial class narchbootcamp
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aec94ded-73fa-4268-adcf-69c9c6e7020b"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 3, 25, 14, 0, 4, 421, DateTimeKind.Local).AddTicks(9591),
                            DateOfBirth = new DateTime(2024, 3, 25, 14, 0, 4, 421, DateTimeKind.Local).AddTicks(9584),
                            Email = "narch@kodlama.io",
                            FirstName = "Beytullah",
                            LastName = "Tapan",
                            NationalIdentity = "1234567",
                            PasswordHash = new byte[] { 40, 199, 46, 89, 206, 26, 142, 114, 229, 129, 136, 141, 240, 145, 83, 183, 117, 213, 75, 153, 192, 147, 145, 10, 33, 138, 114, 28, 57, 83, 69, 242, 101, 103, 32, 79, 61, 25, 62, 149, 70, 39, 75, 40, 174, 239, 143, 186, 245, 188, 209, 52, 21, 145, 189, 75, 14, 99, 222, 128, 204, 213, 79, 0 },
                            PasswordSalt = new byte[] { 153, 82, 203, 15, 135, 218, 241, 0, 85, 138, 211, 90, 18, 95, 96, 143, 71, 28, 86, 217, 22, 127, 22, 86, 14, 72, 27, 70, 74, 162, 176, 195, 79, 138, 146, 141, 241, 77, 67, 51, 239, 55, 77, 212, 62, 5, 159, 34, 180, 168, 118, 80, 111, 125, 238, 100, 226, 223, 191, 199, 160, 219, 226, 228, 244, 12, 72, 203, 194, 33, 39, 151, 43, 23, 192, 73, 11, 190, 63, 216, 138, 183, 71, 146, 198, 90, 152, 149, 196, 58, 79, 69, 103, 41, 189, 173, 153, 121, 100, 181, 247, 32, 20, 115, 45, 253, 158, 73, 93, 35, 210, 17, 8, 99, 111, 99, 122, 240, 18, 169, 180, 169, 69, 134, 125, 214, 223, 1 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f0a1b394-b336-4663-a4d1-fc5f07dea6d5"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("aec94ded-73fa-4268-adcf-69c9c6e7020b")
                        });
                });
